...
Feature: Manage policies
  ...
  Scenario: Create new iomadpolicy and save as draft
    ...
    And the field "Type" matches value "Site iomadpolicy"
    ...
    Then the following should exist in the "tool-iomadpolicy-managedocs-wrapper" table:
      ...
      | Policy1 Site iomadpolicy, All users, Compulsory  | Draft         | v1      | N/A        |
    And I log out

  Scenario: Create new iomadpolicy and save as active
    When I log in as "manager"
    And I navigate to "Users > Privacy and policies > Manage policies" in site administration
    And I follow "New iomadpolicy"
    And I set the following fields to these values:
    ...
    Then the following should exist in the "tool-iomadpolicy-managedocs-wrapper" table:
      | Name                                        | Policy status | Version | Agreements  |
      | Policy1 Site iomadpolicy, All users, Compulsory  | Active        | v1      | 0 of 4 (0%) |
    And I log out
  ...
  Scenario: Edit active iomadpolicy and save as minor change
    ...
    Then the following should exist in the "tool-iomadpolicy-managedocs-wrapper" table:
      | Name                                        | Policy status | Version    | Agreements   |
      | Policy1 Site iomadpolicy, All users, Compulsory  | Active        | v1 amended | 1 of 4 (25%) |
    And I log out
  ...
  Scenario: Edit active iomadpolicy and save as draft
    ...
    Then the following should exist in the "tool-iomadpolicy-managedocs-wrapper" table:
      | Name                                        | Policy status | Version    | Agreements   |
      | Policy1 Site iomadpolicy, All users, Compulsory  | Active        | v1         | 1 of 4 (25%) |
      | Policy1 Site iomadpolicy, All users, Compulsory  | Draft         | v2         | N/A          |
    And I log out
  ...
  Scenario: Edit active iomadpolicy and save as new active version
    ...
    Then the following should exist in the "tool-iomadpolicy-managedocs-wrapper" table:
      | Name                                        | Policy status | Version    | Agreements   |
      | Policy2 Site iomadpolicy, All users, Compulsory  | Active        | v2         | 0 of 4 (0%) |
    ...
    Then the following should exist in the "tool-iomadpolicy-managedocs-wrapper" table:
      | Name                                        | Policy status | Version    | Agreements   |
      | Policy1 Site iomadpolicy, All users, Compulsory  | Inactive      | v1         | 1 of 4 (25%) |
    And I log out
  ...
  Scenario: Edit draft iomadpolicy and save as active
    ...
    Then the following should exist in the "tool-iomadpolicy-managedocs-wrapper" table:
      | Name                                        | Policy status | Version    | Agreements   |
      | Policy1 Site iomadpolicy, All users, Compulsory  | Active        | v2         | 0 of 4 (0%)  |
    And I should not see "v1"
    And "View previous versions" "link" should not exist
    And I log out
  ...
  Scenario: Activate draft iomadpolicy
    ...
    Then I should see "All users will be required to agree to this new iomadpolicy version to be able to use the site."
  ...
  Scenario: Edit archived iomadpolicy and save as draft
    ...
    Then I should see "You are about to inactivate iomadpolicy"
    And I press "Continue"
    And the following should exist in the "tool-iomadpolicy-managedocs-wrapper" table:
      | Name                                        | Policy status | Version    | Agreements   |
      | Policy1 Site iomadpolicy, All users, Compulsory  | Inactive      | v1         | 1 of 4 (25%) |
    ...
    And the following should exist in the "tool-iomadpolicy-managedocs-wrapper" table:
      | Name                                        | Policy status | Version    | Agreements   |
      | Policy2 Site iomadpolicy, All users, Compulsory  | Draft         | v2         | N/A          |
    And I should not see "v1"
    And I should not see "Policy1"
    And I click on "View previous versions" "link" in the "Policy2" "table_row"
    And I should see "Policy2 previous versions"
