...
Feature: Viewing acceptances reports and accepting on behalf of other users
  ...
  Scenario: View acceptances made by users on their own, single iomadpolicy
  ...
  Scenario: Agree on behalf of another user as a manager, single iomadpolicy, javascript off
    Given I log in as "admin"
    And I set the following system permissions of "Manager" role:
      | capability | permission |
      | tool/iomadpolicy:acceptbehalf | Allow |
    And I log out
    ...
    And I click on "1 of 4 (25%)" "link" in the "This site iomadpolicy" "table_row"
    And I click on "Accept This site iomadpolicy" "link" in the "User One" "table_row"
    Then I should see "Accepting iomadpolicy"
  ...
  @javascript
  Scenario: Agree on behalf of another user as a manager, single iomadpolicy, javascript on
    Given I log in as "admin"
    And I set the following system permissions of "Manager" role:
      | capability | permission |
      | tool/iomadpolicy:acceptbehalf | Allow |
  ...
  Scenario: View acceptances made by users on their own, multiple policies
    Given I log in as "admin"
    And I navigate to "Users > Privacy and policies > Manage policies" in site administration
    And I click on "Set status to \"Active\"" "link" in the "This privacy iomadpolicy" "table_row"
    ...
    And "Pending" "text" should exist in the "This site iomadpolicy" "table_row"
    And "Pending" "text" should exist in the "This privacy iomadpolicy" "table_row"
  ...
  Scenario: Agree on behalf of another user as a manager, multiple policies, javascript off
    ...
    And I click on "Details" "link" in the "User One" "table_row"
    And "Accepted on user's behalf" "text" should exist in the "This site iomadpolicy" "table_row"
    And "Max Manager" "link" should exist in the "This site iomadpolicy" "table_row"
    And "Consent received from a parent" "text" should exist in the "This site iomadpolicy" "table_row"
    And "Pending" "text" should exist in the "This privacy iomadpolicy" "table_row"
  ...
  Scenario: Agree on behalf of another user as a manager, multiple policies, javascript on
    Given I log in as "admin"
    And I navigate to "Users > Privacy and policies > Manage policies" in site administration
    And I click on "Actions" "link_or_button" in the "This privacy iomadpolicy" "table_row"
    And I click on "Set status to \"Active\"" "link" in the "This privacy iomadpolicy" "table_row"
  ...
  Scenario: Bulk agree on behalf of another users as a manager, multiple policies, javascript on
    ...
    And I click on "Cancel" "button" in the "Accepting iomadpolicy" "dialogue"
    And I should not see "Accepting iomadpolicy"
  ...
  Scenario: View acceptances made by users on their own after inactivating a iomadpolicy
    Given I log in as "user1"
    And I should see "This site iomadpolicy"
    And I should not see "Course overview"
    And I press "Next"
    ...
    And I click on "Set status to \"Active\"" "link" in the "This privacy iomadpolicy" "table_row"
    And I press "Continue"
    And I click on "Set status to \"Inactive\"" "link" in the "This privacy iomadpolicy" "table_row"
    And I press "Continue"
    And I log out
    When I log in as "user1"
